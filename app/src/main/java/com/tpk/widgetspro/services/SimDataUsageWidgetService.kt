...
class SimDataUsageWidgetService : Service() {
    ...
    private val updateRunnable = object : Runnable {
        override fun run() {
            SimDataUsageWidgetProvider.updateAllWidgets(this@SimDataUsageWidgetService)
    ...
    override fun onCreate() {
        ...
        startForeground(
            6,
            createNotification(
                "sim_data_usage_widget_service_channel",
                "Sim Data Usage Widget Active"
            )
        )
    ...
    private fun createNotification(channelId: String, title: String): Notification {
        ...
        val channel = NotificationChannel(
            channelId,
            "Sim Data Usage Widget Updater Service",
