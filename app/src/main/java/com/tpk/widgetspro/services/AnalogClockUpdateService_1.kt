...
class AnalogClockUpdateService_1 : BaseMonitorService() {
    ...
    private fun createClockViews(hourAngle: Float, minuteAngle: Float, secondAngle: Float): RemoteViews {
        return RemoteViews(packageName, R.layout.analog_1_widget).apply {

            setInt(R.id.analog_1_container, "setBackgroundResource", R.drawable.analog_1_bg)
            setImageViewResource(R.id.analog_1_dial,
                if (isSystemInDarkTheme(this@AnalogClockUpdateService_1))
                    R.drawable.analog_1_dial_dark
                else
                    R.drawable.analog_1_dial_light)


            val prefs = getSharedPreferences("theme_prefs", Context.MODE_PRIVATE)
            val isDarkTheme = prefs.getBoolean("dark_theme", isSystemInDarkTheme(this@AnalogClockUpdateService_1))
            ...
            val themedContext = ContextThemeWrapper(this@AnalogClockUpdateService_1, themeResId)
            ...
            setImageViewResource(R.id.analog_1_hour, R.drawable.analog_1_hour)
            setImageViewResource(R.id.analog_1_min, R.drawable.analog_1_min)
            setImageViewResource(R.id.analog_1_secs, R.drawable.analog_1_secs)


            setInt(R.id.analog_1_hour, "setColorFilter", accentColor)
            setInt(R.id.analog_1_min, "setColorFilter", accentColor)
            setInt(R.id.analog_1_secs, "setColorFilter", accentColor)


            setFloat(R.id.analog_1_hour, "setRotation", hourAngle)
            setFloat(R.id.analog_1_min, "setRotation", minuteAngle)
            setFloat(R.id.analog_1_secs, "setRotation", secondAngle)


            setOnClickPendingIntent(R.id.analog_1_container,
                PendingIntent.getActivity(
                    this@AnalogClockUpdateService_1,
